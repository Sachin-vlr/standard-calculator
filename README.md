...
<html>
    ...
    <body>
        <form name="form1" onload="result.value=''">
            <h1 style="text-align: center;color:black;">Simple Calculator</h1>
        <table id="calc">
            <tr>
                <td colspan="4">
...
![Screenshot 2023-05-11 142050](https://github.com/Sachin-vlr/standard-calculator/assets/113497666/34d273b5-125b-40d0-a655-938320dfcaa8)
